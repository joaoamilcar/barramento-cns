...
/**
 * <p>Classe Java de PRPA_MT201303UV02.Person complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="PRPA_MT201303UV02.Person">
 *   &lt;complexContent>
 ...
 *         &lt;element name="asPatientOfOtherProvider" type="{urn:hl7-org:v3}PRPA_MT201303UV02.PatientOfOtherProvider" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asEmployee" type="{urn:hl7-org:v3}PRPA_MT201303UV02.Employee" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asCitizen" type="{urn:hl7-org:v3}PRPA_MT201303UV02.Citizen" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asStudent" type="{urn:hl7-org:v3}PRPA_MT201303UV02.Student" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asMember" type="{urn:hl7-org:v3}PRPA_MT201303UV02.Member" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asOtherIDs" type="{urn:hl7-org:v3}PRPA_MT201303UV02.OtherIDs" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="contactParty" type="{urn:hl7-org:v3}PRPA_MT201303UV02.ContactParty" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="guardian" type="{urn:hl7-org:v3}PRPA_MT201303UV02.Guardian" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="personalRelationship" type="{urn:hl7-org:v3}PRPA_MT201303UV02.PersonalRelationship" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="careGiver" type="{urn:hl7-org:v3}PRPA_MT201303UV02.CareGiver" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="birthPlace" type="{urn:hl7-org:v3}PRPA_MT201303UV02.BirthPlace" minOccurs="0"/>
 *         &lt;element name="guarantorRole" type="{urn:hl7-org:v3}COCT_MT670000UV04.GuarantorRole" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="languageCommunication" type="{urn:hl7-org:v3}PRPA_MT201303UV02.LanguageCommunication" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPA_MT201303UV02.Person", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPAMT201303UV02Person {
    ...
    protected List<PRPAMT201303UV02PatientOfOtherProvider> asPatientOfOtherProvider;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UV02Employee> asEmployee;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UV02Citizen> asCitizen;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UV02Student> asStudent;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UV02Member> asMember;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UV02OtherIDs> asOtherIDs;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UV02ContactParty> contactParty;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UV02Guardian> guardian;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UV02PersonalRelationship> personalRelationship;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UV02CareGiver> careGiver;
    @XmlElementRef(name = "birthPlace", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<PRPAMT201303UV02BirthPlace> birthPlace;
    @XmlElement(nillable = true)
    protected List<COCTMT670000UV04GuarantorRole> guarantorRole;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UV02LanguageCommunication> languageCommunication;
    ...
    /**
     * Obtém o valor da propriedade deceasedTime.
     * 
     * @return
     *     possible object is
     *     {@link TS }
    ...
    /**
     * Define o valor da propriedade deceasedTime.
     * 
     * @param value
     *     allowed object is
     *     {@link TS }
    ...
    /**
     * Obtém o valor da propriedade educationLevelCode.
     * 
     * @return
     *     possible object is
     *     {@link CE }
    ...
    /**
     * Define o valor da propriedade educationLevelCode.
     * 
     * @param value
     *     allowed object is
     *     {@link CE }
    ...
    /**
     * Obtém o valor da propriedade livingArrangementCode.
     * 
     * @return
     *     possible object is
     *     {@link CE }
    ...
    /**
     * Define o valor da propriedade livingArrangementCode.
     * 
     * @param value
     *     allowed object is
     *     {@link CE }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UV02PatientOfOtherProvider }
     * 
     * 
     */
    public List<PRPAMT201303UV02PatientOfOtherProvider> getAsPatientOfOtherProvider() {
        if (asPatientOfOtherProvider == null) {
            asPatientOfOtherProvider = new ArrayList<PRPAMT201303UV02PatientOfOtherProvider>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UV02Employee }
     * 
     * 
     */
    public List<PRPAMT201303UV02Employee> getAsEmployee() {
        if (asEmployee == null) {
            asEmployee = new ArrayList<PRPAMT201303UV02Employee>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UV02Citizen }
     * 
     * 
     */
    public List<PRPAMT201303UV02Citizen> getAsCitizen() {
        if (asCitizen == null) {
            asCitizen = new ArrayList<PRPAMT201303UV02Citizen>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UV02Student }
     * 
     * 
     */
    public List<PRPAMT201303UV02Student> getAsStudent() {
        if (asStudent == null) {
            asStudent = new ArrayList<PRPAMT201303UV02Student>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UV02Member }
     * 
     * 
     */
    public List<PRPAMT201303UV02Member> getAsMember() {
        if (asMember == null) {
            asMember = new ArrayList<PRPAMT201303UV02Member>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UV02OtherIDs }
     * 
     * 
     */
    public List<PRPAMT201303UV02OtherIDs> getAsOtherIDs() {
        if (asOtherIDs == null) {
            asOtherIDs = new ArrayList<PRPAMT201303UV02OtherIDs>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UV02ContactParty }
     * 
     * 
     */
    public List<PRPAMT201303UV02ContactParty> getContactParty() {
        if (contactParty == null) {
            contactParty = new ArrayList<PRPAMT201303UV02ContactParty>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UV02Guardian }
     * 
     * 
     */
    public List<PRPAMT201303UV02Guardian> getGuardian() {
        if (guardian == null) {
            guardian = new ArrayList<PRPAMT201303UV02Guardian>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UV02PersonalRelationship }
     * 
     * 
     */
    public List<PRPAMT201303UV02PersonalRelationship> getPersonalRelationship() {
        if (personalRelationship == null) {
            personalRelationship = new ArrayList<PRPAMT201303UV02PersonalRelationship>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UV02CareGiver }
     * 
     * 
     */
    public List<PRPAMT201303UV02CareGiver> getCareGiver() {
        if (careGiver == null) {
            careGiver = new ArrayList<PRPAMT201303UV02CareGiver>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PRPAMT201303UV02BirthPlace }{@code >}
     *     
     */
    public JAXBElement<PRPAMT201303UV02BirthPlace> getBirthPlace() {
        return birthPlace;
    }
     ...
     *     
     */
    public void setBirthPlace(JAXBElement<PRPAMT201303UV02BirthPlace> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UV02LanguageCommunication }
     * 
     * 
     */
    public List<PRPAMT201303UV02LanguageCommunication> getLanguageCommunication() {
        if (languageCommunication == null) {
            languageCommunication = new ArrayList<PRPAMT201303UV02LanguageCommunication>();
        }
