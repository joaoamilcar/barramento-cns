...
/**
 * <p>Classe Java de PRPA_MT201301UV02.Person complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="PRPA_MT201301UV02.Person">
 *   &lt;complexContent>
 ...
 *         &lt;element name="asStudent" type="{urn:hl7-org:v3}PRPA_MT201301UV02.Student" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="languageCommunication" type="{urn:hl7-org:v3}PRPA_MT201301UV02.LanguageCommunication" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPA_MT201301UV02.Person", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPAMT201301UV02Person {
    ...
    @XmlElement(nillable = true)
    protected List<PRPAMT201301UV02Employee> asEmployee;
    @XmlElement(nillable = true)
    protected List<PRPAMT201301UV02Citizen> asCitizen;
    @XmlElement(nillable = true)
    protected List<PRPAMT201301UV02Student> asStudent;
    @XmlElement(nillable = true)
    ...
    @XmlElement(nillable = true)
    protected List<PRPAMT201301UV02LanguageCommunication> languageCommunication;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UV02Employee }
     * 
     * 
     */
    public List<PRPAMT201301UV02Employee> getAsEmployee() {
        if (asEmployee == null) {
            asEmployee = new ArrayList<PRPAMT201301UV02Employee>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UV02Citizen }
     * 
     * 
     */
    public List<PRPAMT201301UV02Citizen> getAsCitizen() {
        if (asCitizen == null) {
            asCitizen = new ArrayList<PRPAMT201301UV02Citizen>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UV02Student }
     * 
     * 
     */
    public List<PRPAMT201301UV02Student> getAsStudent() {
        if (asStudent == null) {
            asStudent = new ArrayList<PRPAMT201301UV02Student>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UV02LanguageCommunication }
     * 
     * 
     */
    public List<PRPAMT201301UV02LanguageCommunication> getLanguageCommunication() {
        if (languageCommunication == null) {
            languageCommunication = new ArrayList<PRPAMT201301UV02LanguageCommunication>();
        }
