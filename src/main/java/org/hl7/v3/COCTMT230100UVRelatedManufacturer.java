...
/**
 * <p>Classe Java de COCT_MT230100UV.RelatedManufacturer complex type.
 * 
 ...
 *         &lt;element name="representedManufacturer" type="{urn:hl7-org:v3}COCT_MT230100UV.Manufacturer" minOccurs="0"/>
 *       &lt;/sequence>
...
public class COCTMT230100UVRelatedManufacturer {
    ...
    @XmlElementRef(name = "representedManufacturer", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    ...
    /**
     * Obtém o valor da propriedade representedManufacturer.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define o valor da propriedade representedManufacturer.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link COCTMT230100UVManufacturer }{@code >}
