...
/**
 * <p>Classe Java de COCT_MT260003UV.OtherMedication complex type.
 * 
...
@XmlType(name = "COCT_MT260003UV.OtherMedication", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "consumable"
})
public class COCTMT260003UVOtherMedication {

    protected List<CS> realmCode;
    protected II typeId;
    protected List<II> templateId;
    @XmlElement(required = true)
    protected COCTMT260003UVConsumable consumable;
