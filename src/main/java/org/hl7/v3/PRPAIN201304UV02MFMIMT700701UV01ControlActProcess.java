...
/**
 * <p>Classe Java de PRPA_IN201304UV02.MFMI_MT700701UV01.ControlActProcess complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="PRPA_IN201304UV02.MFMI_MT700701UV01.ControlActProcess">
 *   &lt;complexContent>
 ...
 *         &lt;element name="subject" type="{urn:hl7-org:v3}PRPA_IN201304UV02.MFMI_MT700701UV01.Subject1" maxOccurs="unbounded"/>
...
@XmlType(name = "PRPA_IN201304UV02.MFMI_MT700701UV01.ControlActProcess", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPAIN201304UV02MFMIMT700701UV01ControlActProcess {
    ...
    protected List<MFMIMT700701UV01Overseer> overseer;
    @XmlElement(nillable = true)
    protected List<MFMIMT700701UV01AuthorOrPerformer> authorOrPerformer;
    @XmlElement(nillable = true)
    protected List<MFMIMT700701UV01DataEnterer> dataEnterer;
    @XmlElement(nillable = true)
    protected List<MFMIMT700701UV01InformationRecipient> informationRecipient;
    @XmlElement(required = true, nillable = true)
    protected List<PRPAIN201304UV02MFMIMT700701UV01Subject1> subject;
    @XmlElement(nillable = true)
    protected List<MFMIMT700701UV01Reason> reasonOf;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link MFMIMT700701UV01Overseer }
     * 
     * 
     */
    public List<MFMIMT700701UV01Overseer> getOverseer() {
        if (overseer == null) {
            overseer = new ArrayList<MFMIMT700701UV01Overseer>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link MFMIMT700701UV01AuthorOrPerformer }
     * 
     * 
     */
    public List<MFMIMT700701UV01AuthorOrPerformer> getAuthorOrPerformer() {
        if (authorOrPerformer == null) {
            authorOrPerformer = new ArrayList<MFMIMT700701UV01AuthorOrPerformer>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link MFMIMT700701UV01DataEnterer }
     * 
     * 
     */
    public List<MFMIMT700701UV01DataEnterer> getDataEnterer() {
        if (dataEnterer == null) {
            dataEnterer = new ArrayList<MFMIMT700701UV01DataEnterer>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link MFMIMT700701UV01InformationRecipient }
     * 
     * 
     */
    public List<MFMIMT700701UV01InformationRecipient> getInformationRecipient() {
        if (informationRecipient == null) {
            informationRecipient = new ArrayList<MFMIMT700701UV01InformationRecipient>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAIN201304UV02MFMIMT700701UV01Subject1 }
     * 
     * 
     */
    public List<PRPAIN201304UV02MFMIMT700701UV01Subject1> getSubject() {
        if (subject == null) {
            subject = new ArrayList<PRPAIN201304UV02MFMIMT700701UV01Subject1>();
        }
        return this.subject;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link MFMIMT700701UV01Reason }
     * 
     * 
     */
    public List<MFMIMT700701UV01Reason> getReasonOf() {
        if (reasonOf == null) {
            reasonOf = new ArrayList<MFMIMT700701UV01Reason>();
        }
