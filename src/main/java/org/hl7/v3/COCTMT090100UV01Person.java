...
/**
 * <p>Classe Java de COCT_MT090100UV01.Person complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="COCT_MT090100UV01.Person">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{urn:hl7-org:v3}InfrastructureRootElements"/>
 *         &lt;element name="name" type="{urn:hl7-org:v3}EN" maxOccurs="unbounded"/>
 *         &lt;element name="asLicensedEntity" type="{urn:hl7-org:v3}COCT_MT090100UV01.LicensedEntity" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asMember" type="{urn:hl7-org:v3}COCT_MT090100UV01.Member" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asRoleOther" type="{urn:hl7-org:v3}COCT_MT090100UV01.RoleOther" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asLocatedEntity" type="{urn:hl7-org:v3}COCT_MT070000UV01.LocatedEntity" minOccurs="0"/>
 *         &lt;element name="languageCommunication" type="{urn:hl7-org:v3}COCT_MT090100UV01.LanguageCommunication" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "COCT_MT090100UV01.Person", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "name",
...
public class COCTMT090100UV01Person {
    ...
    protected List<COCTMT090100UV01LicensedEntity> asLicensedEntity;
    @XmlElement(nillable = true)
    protected List<COCTMT090100UV01Member> asMember;
    @XmlElement(nillable = true)
    protected List<COCTMT090100UV01RoleOther> asRoleOther;
    ...
    @XmlElement(nillable = true)
    protected List<COCTMT090100UV01LanguageCommunication> languageCommunication;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT090100UV01LicensedEntity }
     * 
     * 
     */
    public List<COCTMT090100UV01LicensedEntity> getAsLicensedEntity() {
        if (asLicensedEntity == null) {
            asLicensedEntity = new ArrayList<COCTMT090100UV01LicensedEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT090100UV01Member }
     * 
     * 
     */
    public List<COCTMT090100UV01Member> getAsMember() {
        if (asMember == null) {
            asMember = new ArrayList<COCTMT090100UV01Member>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT090100UV01RoleOther }
     * 
     * 
     */
    public List<COCTMT090100UV01RoleOther> getAsRoleOther() {
        if (asRoleOther == null) {
            asRoleOther = new ArrayList<COCTMT090100UV01RoleOther>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT090100UV01LanguageCommunication }
     * 
     * 
     */
    public List<COCTMT090100UV01LanguageCommunication> getLanguageCommunication() {
        if (languageCommunication == null) {
            languageCommunication = new ArrayList<COCTMT090100UV01LanguageCommunication>();
        }
