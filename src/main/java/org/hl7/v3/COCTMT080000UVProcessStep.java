...
/**
 * <p>Classe Java de COCT_MT080000UV.ProcessStep complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="COCT_MT080000UV.ProcessStep">
 *   &lt;complexContent>
 ...
 *         &lt;element name="subject1" type="{urn:hl7-org:v3}COCT_MT080000UV.Subject1" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="subject2" type="{urn:hl7-org:v3}COCT_MT080000UV.Subject2" maxOccurs="unbounded" minOccurs="0"/>
...
public class COCTMT080000UVProcessStep {
    ...
    protected List<COCTMT080000UVSubject1> subject1;
    @XmlElement(nillable = true)
    protected List<COCTMT080000UVSubject2> subject2;
    @XmlElement(nillable = true)
     ...
     * 
     */
    public List<COCTMT080000UVSubject1> getSubject1() {
        if (subject1 == null) {
            subject1 = new ArrayList<COCTMT080000UVSubject1>();
        }
     ...
     * 
     */
    public List<COCTMT080000UVSubject2> getSubject2() {
        if (subject2 == null) {
            subject2 = new ArrayList<COCTMT080000UVSubject2>();
        }
